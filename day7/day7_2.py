...
def calOuterfunc( file :TreeNode):
    ...
    return answer
def smallYetBigEnough(file:TreeNode, clear:int,mini):
    print('need to clear:',clear)
    # clear <= answer < other dir
    if file.dir == True:
        print(file.get_name())
        if clear<=file.get_size()<= mini:
    ...
    for i in file.children:
        ...
        if i.dir == True:
            print(i.get_name())
            if clear<=i.get_size()<= mini:
                mini = i.get_size()
                print(' children mini:',mini)
...
mini = 70000000
print('answer:',smallYetBigEnough(filesys,30000000 - (70000000-filesys.totalsize()),mini) )
#48381665
#48391665
#50391665
#90391665
